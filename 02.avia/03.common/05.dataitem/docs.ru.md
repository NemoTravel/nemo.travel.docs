...
-   **CashValueForMultiFOPProxing.CashValue** — значение суммы для cash части при мульти-FOP GDS-процессинге через сторонние платежные шлюзы. Тип данных — [Money](/avia/common/money)(/avia/common/money). 
