...
-   **AdditionalLocators** - используется в uAPI и NemoNetwork для отображение локатора, по которому можно прочитать ПНР в терминале ГРС (необязательный). Тип данных — массив.
