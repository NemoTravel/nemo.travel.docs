...
-  **Type** - The type of content in this data block. Data type - enumeration, possible values:
	...
	-   ReferencedBooks
	-   DiscountDocument
-  **Remark** - The rext note. The custom data type.
...
- **Document** - The document proving the identity of the traveler. The custom data type.
...
- **ContactInfo** - Contact details. The custom data type.
...
- **LoyaltyCard** - The Loyalty card. The custom data type.
...
- **ElectronicDocument** - Some electronic document (ED) (ticket / EMD). The custom data type.
...
- **PaperDocument** - A paper document. The custom data type.
...
- **Endorsements** - Endorsements. The custom data type.
...
- **BookedSeat** - The data of the booked seat from the seat card. The custom data type.
...
- **DiscountDocument** - The passenger document, which is the basis for the subsidy / discount. The custom data type.
