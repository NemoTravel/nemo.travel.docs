...
-   **FlightSegment** - The flight segment. The data type is complex.
...
-   **FlightSegment.ArrivalAirport** - The arrival airport information. The data type is TripPointInformation.
-   **FlightSegment.StopPoints** - Stop points on this segment. The data type is an array of StopPoint elements.
-   **FlightSegment.StopPoints.StopPoint** - The stop point on this segment. The data type is complex, the successor to TripPointInformation.
