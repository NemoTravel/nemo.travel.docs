...
-   **Tariff.FareFamilyDescID** - идентификатор описания семейства тарифов. Тип данных — целое число.
-   **Tariff.FareFamilyCode** - код авиакомпании семейства тарифов. Тип данных — строка.
-   **Tariff.Cabin** - класс перелёта. Тип данных — строка.
...
-   **Tariff.SubType** - информация об особенностях тарификации, например, означающая оценку по М2 условиям.Тип данных — строка.
   -    M2 — М2 оценка.
