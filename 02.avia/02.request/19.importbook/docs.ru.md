...
- **TicketNumber** - номер билета в ГДС. Тип данных - числовой. (Поддерживается на данный момент только в ГДС Sirena Travel. Необязательный параметр, используется только при работе с Sirena Travel. Импорт возможен по одному PNRCode, по одному TicketNumber или по PNRCode и TicketNumber вместе.)
