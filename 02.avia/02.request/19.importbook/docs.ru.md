...
- **Source** - ID источника, в которой находится PNR, на основании которого требуется создать бронь. Тип данных - целое 32-битное число:
- **PNRCode** - ID PNR в GDS. Тип данных - строка.
...
- **AdditionalInformation.TripPointInfoList** - контейнер со списком пар аэропортов. Необязательный параметр, используется для оптимизации работы импорта. Тип данных - сложный.
