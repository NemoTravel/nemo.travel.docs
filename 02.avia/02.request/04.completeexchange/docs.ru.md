...
-   **BookID** - ИД брони, для которой требуется завершить обмен. Тип данных - целое 64-битное число. (обязательное поле)
...
В ответе бронь, т.е. ответ аналогичен ответу на запрос [BookFlight\_2\_0](/avia/request/bookflight).
