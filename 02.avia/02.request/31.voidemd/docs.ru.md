...
Войдирование EMD для различных допуслуг в брони.
...
#### VoidEMD_1_1
#### Формат запроса
* **BookID** - ID брони, для которой производится операция. Тип данных - long. (обязательное поле)
* **ServiceRefs** - Список ID допуслуг в брони, для которых требуется произвести операцию. Тип данных - массив int.
* **ServiceRefs.Ref** - ID допуслуги в брони, для которой требуется произвести операцию. Тип данных - int. (обязательное поле)
#### Пример запроса 
...
<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:avia="http://nemo-ibe.com/Avia" xmlns:stl="http://nemo-ibe.com/STL">
 ...
 #### Формат запроса
*  **BookID** - ID брони, к которой относятся EMD, которые требуется провойдировать. Тип данных - long.
