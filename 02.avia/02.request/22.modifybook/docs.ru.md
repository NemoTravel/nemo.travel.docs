...
Внесения изменений в бронь. Ответ аналогичен ответу из [брони версии 2.0](/avia/common/book). Включает в себя функциональность ModifyBook и AddInformation более ранних версий.
