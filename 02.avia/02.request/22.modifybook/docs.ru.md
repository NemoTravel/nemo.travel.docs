...
Используется для внесения изменений в брон с [бронью версии 2.0](/avia/common/book) в качестве ответа. Включает в себя функциональность ModifyBook и AddInformation более ранних версий.
