...
Используется для внесения изменений в бронь. Ответ аналогичен ответу из [брони версии 2.0](/avia/common/book). Включает в себя функциональность ModifyBook и AddInformation более ранних версий.

#### Запрос

-   **BookID** - ID брони, в которую требуется внести изменения. Тип данных - long.
