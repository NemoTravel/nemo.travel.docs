...
Request for seat release.

#### Request

##### Format Description

-   **BookID** — ID of the booking which you want to cancel (mandatory). Data type — long.
-   **Travellers.Ref** — number of passenger in booking (optional). Data type — 32-bit integer.
