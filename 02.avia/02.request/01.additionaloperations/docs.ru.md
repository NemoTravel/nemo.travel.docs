...
1. В ответе на запрос SearchAncillaryServices среди услуг ищутся услуги места с Characteristics и RFISC, соответствующими Characteristics и RFISC места из карты мест. Characteristics и RFISC должны обязательно присутствовать;
