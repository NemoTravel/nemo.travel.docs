...
-   **BookID** - ИД брони с пассажирами. Тип данных - целое 64-битное число.(обязательно поле)
...
-   **Traveller** - новая информация о пассажире для обмена. Переключает сценарий обмена на рассчет стоимости обмена при изменении персональных данных. Тип данных - элемент типа [ExchangeTraveller](/avia/common/exchangetraveller)
