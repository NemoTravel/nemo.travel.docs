...
[Бронь версии 2.0](Общие_элементы_API#Book "wikilink") с отспличенными пассажирами. Информация о родительской и дочерних бронях сохраняется в ***DataItems.[DataItem](Общие_элементы_API#DataItem "wikilink").ReferencedBooks***.
