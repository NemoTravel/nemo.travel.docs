...
-   **RequestedFlightInfo.ODPair.DepatureAltPoints** - содержит список альтернативных аэропортов отправления. Тип данных - сложный.[^1]
...
[^1]: При запросе альтернативных аэропортов, для ГРС Сейбр не будут запрошены альтернативные классы/тарифы перелетов - ограничение ГРС.