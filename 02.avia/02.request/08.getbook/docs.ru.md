...
Получение текущего состояния брони без синхронизации с поставщиком.Получение информации возможно с помощью BookID и с помощью PNRParams, см.примеры использования.
...
-   **BookID** - ИД брони, которую требуется получить. Тип данных - long. (обязательное поле)
-   **PNRParams:**
