...
-   **CancelPayment** - Признак необходимости отменить старую оплату брони (необязательный). Тип данных - булевый.
...
-   **FillEdDocContent** - запрашивать электронные документы (маршрут-квитанция, EMD) в PDF (необязательный). Поддерживается для Sirena, Sirena NDC. Тип данных - булевый.
