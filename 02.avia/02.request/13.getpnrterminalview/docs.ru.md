...
Получение терминального вида PNR для брони.

#### Запрос

##### Описание формата

-   **BookID** - ID брони, для которой требуется получить терминальный вид. Тип данных - целое 64-битное число. (Обязательно поле)
