...
Актуализация статуса заказа. С помощью данного запроса можно как обновлять информацию о заказе из бэк-офиса Nemo.travel, так и обновлять статус платежных транзакций.
#### Параметры запроса
