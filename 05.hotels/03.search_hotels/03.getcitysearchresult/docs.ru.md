...
-   **isFinished** - аттрибут, показывающий, полностью ли завершен поиск. Тип данных - булевский.
...
-   **RoomRatesGroup.Rate.IsSpecialOffer** - аттрибут тарифа как специального предложения. Тип данных - булевский.
