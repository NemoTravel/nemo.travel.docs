...
-   **RoomRatesGroup.Rate.BookingRemarks** - ремарки. Тип данных - сложный.
...
-   **Hotels.Hotel.RoomGroups** - информация о доступных комнатах. Тип данных - сложный.
...
-   **Hotels.Hotel.EarlyCheckInGroup.CheckInOutOffer.Guaranteed** - содержит информацию о признаке, является ли услуга гарантированной. Тип данных - булевский.
...
-   **Hotels.Hotel.LateCheckOutGroup.CheckInOutOffer** - содержит информацию о варианте. Тип данных - сложный. Идентичен Hotels.Hotel.EarlyCheckInGroup.CheckInOutOffer
