...
-   **SearchHotels** - Выполнять ли автокомплит по отелям. Тип данных - булевский.
-   **SearchCities** - Выполнять ли автокомплит по городам. Тип данных - булевский.
-   **SearchCountries** - Выполнять ли автокомплит по странам. Тип данных - булевский.
