...
-   **Train** - Поезд с полной информацией. Тип данных - сложный. Структура аналогична параметру Train из ответа на запрос поиска, но с дополненной информацией о вагоне.
