...
-   **LocalBeginDate**  - Дата и время отправления по местному времени(станции отправки). Формат - yyyy-mm-dd hh:mm:ss, например - 2011-05-12 23:10:00. Тип данных - строка.
