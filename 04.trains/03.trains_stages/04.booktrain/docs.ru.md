...
-   **TariffCode** - Код выбраного тарифа поезда.Тип данных - перечисление, возможные значения:
    - **Полный** = 1,
    - **Детский(до 10 лет)** = 2,
    - **Детский без места(до 5 лет)** = 3,
    - **SENIOR(60+) в Сапсан** = 4,
    - **SENIOR(от 60 лет)** = 5,
    - **JUNIOR(от 12 до 26 лет)** = 6,
    - **Детский(до 12 лет)** = 7,
    - **Детский без места(до 4 лет)** = 8,
    - **Детский(до 17 лет)** = 9,
    - **Детский без места(до 6 лет)** = 10,
    - **Детский(до 7 лет)** = 11,
    - **Детский без места(до 10 лет)** = 12,
    - **Детский(от 10 до 17 лет)** = 13,
    - **Школьник (для учащихся от 10 лет)** = 14,
    - **Детский без места (для детей до 12 лет)** = 15,
    - **Детский без места (для детей до 6 лет)** = 16,
    - **Молодежный ЮНИОР (для лиц от 10 до 21 года)** = 17,
    - **Праздничный** = 18,
    - **Свадебный** = 19,
    - **Семейный** = 20
