---
title: 'Получение маршрут-квитанции для определённой брони'
---
...
-   **RefundId** - Идентификатор возврата бланка в УФС или идентификатор бланка в УИТ. Тип данных - строка.

Если требуется получить все имеющиеся бланки брони, то параметр RefundId следует оставить пустым.
...
-   **TicketBlanks.TicketBlank.Format** - Формат/кодировка маршрут квитанции. Тип данных - перечисление. Возможные значения аналогичны параметру BlankPrefferredType из запроса на бронирование.
