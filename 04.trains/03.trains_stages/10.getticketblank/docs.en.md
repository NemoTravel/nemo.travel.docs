...
Getting itinerary receipt for a specific booking.
...
-   **DateTimeFrom** - Departure date. Data type - string.
-   **DateTimeTo** - Date of arrival. Data type - string.
-   **Train** - Train. Data type - string.
-   **TrainArrival** - Train on arrival. Data type - string.
-   **Car** - Car. Data type - string.
-   **Place** - Place. Data type - string.
-   **Services** - Services. Data type - string.
-   **UID** - The unique document ID. Data type - string.
