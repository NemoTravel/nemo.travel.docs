...
### OrderRetrieve
Обновление заказа с синхронизацией в GDS и без.

#### Запрос
-	**Header.GetCached** - принимает булевое значение true или false. В случае, если значение true, выполняется обновление брони без синхронизации с GDS; если значение false или отсутствует, выполняется обновление с синхронизацией в GDS.
...
-	**Filters.OrderID** - уникальный идентификатор заказа в Nemo Connect. Атрибут Owner содержит код владельца (GDS). 
