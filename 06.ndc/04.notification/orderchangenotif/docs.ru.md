...
#### Как настроить
* Перейди в раздел /settings__nc_notifications;
* Включи настройку enable_notify;
* В поле notification_url укажи адрес для отправки нотификаций (например, https://test.graphql.mlsd.ru/notifications/accept);
* В настройке format выбери формат отправки нотификаций (AviaAPI или NDC).
